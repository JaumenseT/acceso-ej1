...
namespace PlaceMyBet.Repositories {
    public class ApuestasRepository {
        internal Apuesta[] RetrieveAll()
        {
            ...
            command.CommandText = "Select idApuesta, tipoApuesta, cuota, dineroApostado, apuesta.idMercado, apuesta.idUsuario, tipoMercado, email from apuesta, mercado, usuario Where" +
            ...
            while (reader.Read()) {
                resultado.Add(new Apuesta(reader.GetInt32("idApuesta"), reader.GetChar("tipoApuesta"),
                    ...
                    reader.GetInt32("idUsuario"), reader.GetDouble("tipoMercado"), reader.GetString("email"))) ;
            }
            con.Close();
